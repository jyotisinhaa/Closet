  ...
  return (
    ...
    >
        ...
        <div style={{ borderBottom: "1px solid var(--line)" }}>
          ...
          >
            <div>
              ...
              <div style={ROW_HINT}>Keep your account secure</div>
            </div>
            <button
              style={BTN_OUTLINE}
              onClick={() => {
      ...
      <div style={{ ...CARD, marginBottom: "48px" }}>
        ...
        <div style={row()}>
          <div>
            <div style={{ ...ROW_LABEL, fontWeight: 700 }}>
              Reset your style profile
            </div>
            <div style={ROW_HINT}>
        ...
        <div style={row(true)}>
          <div>
            <div style={{ ...ROW_LABEL, fontWeight: 700 }}>Delete account</div>
            <div style={ROW_HINT}>
