...
import { BODY_TYPES } from "../../lib/profileConstants.jsx";
...
export default function Onboarding() {
  ...
  if (isComplete) {
    const bodyLabel =
      BODY_TYPES.find((b) => b.key === savedProfile.bodyType)?.label ??
      savedProfile.bodyType;
    const bodySvg = BODY_TYPES.find(
      (b) => b.key === savedProfile.bodyType,
    )?.svg;
        ...
        <div style={{ position: "relative", marginBottom: "28px" }}>
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "linear-gradient(135deg, rgba(91,106,63,0.15), rgba(91,106,63,0.05))",
      ...
      >
        <div style={{ width: "100%", maxWidth: "540px" }}>
          ...
          >
            ...
            <span style={{ color: "var(--gold)", fontSize: "0.7em" }}>✦</span>
          </h1>
          <p
            style={{
              fontFamily: "'Fraunces', serif",
          ...
          <div style={{ marginBottom: "28px" }}>
            ...
            <p style={sectionSub}>
              Helps us show the most relevant clothing fits
            </p>
                ...
                (opt) => (
                  <button
                    ...
                    style={{
                      ...
                      background:
                        gender === opt ? "rgba(194,86,58,0.07)" : "white",
                      color:
                        gender === opt
                          ? "var(--terracotta)"
                          : "var(--ink-soft)",
          ...
          <div style={{ marginBottom: "28px" }}>
            ...
            <p style={sectionSub}>
              So we can suggest the best cuts and silhouettes for you
            </p>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: sel
                        ? "1.5px solid var(--terracotta)"
                        : hovered
                          ? "1.5px solid rgba(194,86,58,0.4)"
                          : "1.5px solid var(--line)",
                      background: sel
                        ? "rgba(194,86,58,0.06)"
                        : hovered
                      ...
                      style={{
                        color: sel
                          ...
                          : hovered
                            ? "rgba(194,86,58,0.7)"
                            : "var(--ink-soft)",
                        opacity: sel ? 1 : hovered ? 0.85 : 0.55,
                        transition: "all 0.18s ease",
                      }}
                    >
                      {b.svg}
          ...
          <div style={{ marginBottom: "36px" }}>
            ...
            <p style={sectionSub}>
              A full-body shot works best — we use it to render every try-on
            </p>
            <div
              ...
              {photo && (
                <div
                  style={{
                    ...
                    padding: "10px 14px",
                    borderRadius: "10px",
                    background: "rgba(91,106,63,0.08)",
                    border: "1.5px solid rgba(91,106,63,0.2)",
                  }}
                >
                  <svg
                    width="14"
