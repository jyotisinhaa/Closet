...
export const CATEGORIES_FEMALE = ['Top', 'Jeans', 'Bottom', 'Dress', 'Skirt', 'Outerwear', 'Shoes', 'Bag', 'Accessory']
export const CATEGORIES_MALE   = ['Top', 'Shirt', 'Jeans', 'Bottom', 'Outerwear', 'Shoes', 'Bag', 'Accessory']
export const CATEGORIES_ALL    = ['Top', 'Shirt', 'Jeans', 'Bottom', 'Dress', 'Skirt', 'Outerwear', 'Shoes', 'Bag', 'Accessory']
